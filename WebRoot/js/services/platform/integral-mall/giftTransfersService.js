...
define(['../../../app'], function (app) {
    app.factory('giftTransfers', ['$http','$q','$filter','HOST',function ($http,$q,$filter,HOST) {
        return {
            getThead: function () {
                return [
                    ...
                    {field:'chuHuoName',name:'发货仓库'},
                    {field:'receiverName',name:'收货仓库'},
                    {field:'wlSendWay',name:'承运快递'},
                    {field:'thirdWlId',name:'快递单号'},
                    {field:'state',name:'订单状态'},
            ...
            getSearch: function () {
                ...
                $http.post(HOST+'/giftAllotted/getAllottedQueryList',{})
