...
define(['../../../app'], function (app) {
    app.factory('personalMonitor', ['$http','$q','$filter','HOST',function ($http,$q,$filter,HOST) {
        return {
            getThead: function () {
                return [
                    ...
                    {field:'fBdistributionWay',name:'调拨方式'},
                    {field:'fBthirdpartyWl',name:'调拨第三方物流'},
                    {field:'fBthirdpartyTaskId',name:'调拨第三方单号'},
                    {field:'fBthirdpartyPay',name:'调拨第三方运费'},
            ...
            getSearch: function() {
                ...
                $http.post(HOST + '/personalMonitor/getDicLists',{})
