...
define(['../../../app'], function(app) {
  app.factory('orderPack', ['$http', '$q', '$filter', 'HOST', function($http, $q, $filter, HOST) {
    return {
      getThead: function() {
        return [{
          name:'#',
        ...
        //    name: '实发数量',
        //    input: true,
        //    verify:{min:0,max:'field',field:'pickGoodCount'},
      ...
      getDataTable: function(data) {
        ...
        $http.post(HOST + '/orderBoxDetail/queryOrderBoxDetailList', data)
      ...
      getPrintData: function(url, data) {
