...
define(['../../../app'], function(app) {
  app.factory('taskQuery', ['$http', '$q', '$filter', 'HOST', function($http, $q, $filter, HOST) {
    return {
      getThead: function() {
        return [{
          field: 'pl4GridCount',
      ...
      getSearch: function() {
        ...
        $http.post(HOST + '/workMonitor/getDicLists',{})
      ...
      getDataTable: function(data) {
        ...
        data.param = $filter('json')(data.param);
        var deferred = $q.defer();
        $http.post(HOST + '/workMonitor/query_workList', data)
          .success(function(data) {
            // console.log(data)
            deferred.resolve(data);
          })
