...
define(['../../../app'], function(app) {
  app.factory('personClearing', ['$http', '$q', '$filter', 'HOST', function($http, $q, $filter, HOST) {
    return {
      getThead: function() {
      ...
      getSearch: function() {
        ...
        $http.post(HOST + '/personalOrder/getBalanceDicList',{})
      ...
      getDataTable: function(data) {
        ...
        var deferred = $q.defer();
        $http.post(HOST + '/personalOrder/queryPerOrderBalance', data)
          .success(function(data) {
            // console.log(data)
            deferred.resolve(data);
          })
