...
define(['../../../app'], function(app) {
  app.factory('deliverOrder', ['$http', '$q', '$filter', 'HOST', function($http, $q, $filter, HOST) {
    return {
      getThead: function() {
        return [{
          name:'序号',
      ...
      getSearch: function(data) {
        ...
        $http.post(HOST + '/takeGoods/getDicList',data)
      ...
      getOrderSearch: function() {
//          data.param = $filter('json')(data.param);
          //console.log()
          var deferred = $q.defer();
          $http.post(HOST + '/orderDeliver/getDeliverDicList')
            .success(function(data) {
              deferred.resolve(data);
            })
            .error(function(e) {
      ...
      cancelConfrim: function (url,data) {
          //将parm转换成json字符串
          data.param=$filter('json')(data.param);
          var deferred=$q.defer();
          $http.post(HOST + url, data)
      ...
      getDataTable: function(data) {
        ...
        data.param = $filter('json')(data.param);
        var deferred = $q.defer();
        $http.post(HOST + '/orderDeliver/queryOrderDeliverList', data)
          .success(function(data) {
            deferred.resolve(data);
          })
          .error(function(e) {
