...
define(['../../../app'], function (app) {
    app.factory('personOrderOutCk', ['$http', '$q', '$filter', 'EHOST', function ($http, $q, $filter, EHOST) {
        return {
            getThead: function () {
            return [{field: 'pl4GridCount',
                ...
                name: '业务单号'
                    ...
                    field: 'shipmentTaskId',
                    name: '分拨出库单号'
                }, {
                  field: 'outGoodsTime',
                  name: '出库时间'
                }, {
                field: 'outGoodsStatus',
                name: '出库状态'
            }, {
                ...
                field: 'fBthirdpartyWl',
                name: '调拨第三方物流'
            }, {
                field: 'fBthirdpartyTaskId',
                name: '调拨第三方单号'
            }, {
                field: 'fBthirdpartyPay',
                name: '调拨第三方运费'
            ...
            getDataTable: function (url,data) {
                ...
                var deferred = $q.defer();
                $http.post(EHOST + (!url ? '/personalOrder/queryConfirmOutGoods' : url), data)
                    .success(function (data) {
                        // console.log(data)
                        deferred.resolve(data);
                    })
