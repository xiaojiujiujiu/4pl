...
define(['../../../app'], function(app) {
  app.factory('deliverVmiOrder', ['$http', '$q', '$filter', 'HOST', function($http, $q, $filter, HOST) {
    return {
      getThead: function() {
        return [{
          name:'序号',
      ...
      getSearch: function(data) {
        ...
        $http.post(HOST + '/returnPickQuery/getVMIDicLists',data)
      ...
      getDataTable: function(data) {
        ...
        data.param = $filter('json')(data.param);
        var deferred = $q.defer();
        $http.post(HOST + '/returnPickQuery/queryVMIReturnPick', data)
          .success(function(data) {
            deferred.resolve(data);
          })
          .error(function(e) {
