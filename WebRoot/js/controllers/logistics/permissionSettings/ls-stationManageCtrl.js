 ...
 */
define(['../../../app','../../../services/logistics/permissionSettings/stationManageService'], function (app) {
     var app = angular.module('app');
    app.controller('lsStationManageCtrl', ['$scope','$sce','stationManage', function ($scope,$sce,stationManage) {
        ...
        //初始化查询数据
        stationManage.getDataTable({param:{'query':wlopts}},'/postInfoManger/getDicLists')
            .then(function (data) {
