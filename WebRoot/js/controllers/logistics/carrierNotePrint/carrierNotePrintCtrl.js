 ...
 */
'use strict';
define(['../../../app', '../../../services/logistics/carrierNotePrint/carrierNotePrintService'], function(app) {
     var app = angular.module('app');
    app.controller('carrierNotePrintCtrl', ['$rootScope','$scope', '$state', '$sce','$window', 'carrierNotePrint', function($rootScope,$scope, $state, $sce,$window, carrierNotePrint) {
        ...
        $scope.tabFlag = true;
        //table头
        $scope.thHeader = carrierNotePrint.getThead();
        //分页下拉框
        $scope.pagingSelect = [{
            value: 5,
            text: 5
        ...
        var pmsSearch = carrierNotePrint.getSearch();
        ...
        function get(printStatu) {
            ...
            var promise = carrierNotePrint.getDataTable('/returnPickQuery/queryReturnPick', {
                param: {query:opts}
            });
        ...
        $scope.print= function () {
            ...
            if(ids!='') {
                ...
                $window.open("/print/carrierNotePrint.html?tokenId="+$rootScope.userInfo.token+"&sessionid="+$rootScope.userInfo.sessionId+"&taskIds="+ids);
        ...
        $scope.printConfirm = function(){
        	var printConfirmPromise = carrierNotePrint.getDataTable('/returnPickQuery/updatePrintStatus',{
        		param: {
        			query:{
