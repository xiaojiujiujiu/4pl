 ...
 */
define(['../../../app','../../../services/storage/specialStorage/newOtherRuOrderService'], function (app) {
     var app = angular.module('app');
    app.controller('newOtherRuOrderCtrl', ['$rootScope', '$scope','$timeout', '$state', '$sce', '$filter', 'HOST', '$window','newOtherRuOrder',
        function ($rootScope, $scope,$timeout, $state, $sce, $filter, HOST, $window,newOtherRuOrder) {
            $scope.querySeting = {
                items: [ {
                    type: 'select',
                    model: 'typeList',
            ...
            //table头
            $scope.thHeader = newOtherRuOrder.getThead();
            $scope.newHeader = newOtherRuOrder.getThead1();
            ...
            var pmsQuery = newOtherRuOrder.getSearch();
            ...
            function get() {
                ...
                var promise = newOtherRuOrder.getDataTable(
            ...
            $scope.confirmImpor=function(){
                ...
                newOtherRuOrder.getDataTable('/ckOtherChuRuOrder/createOrEditCkOtherChuRuOrder', {param: opts})
                    .then(function (data) {
