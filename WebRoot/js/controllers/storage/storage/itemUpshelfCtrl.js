 ...
 */
'use strict';
define(['../../../app', '../../../services/storage/storage/itemUpshelfService'], function(app) {
     var app = angular.module('app');
    app.controller('itemUpshelfCtrl', ['$rootScope','$scope', '$state', '$sce','$window', 'itemUpshelf', function($rootScope,$scope, $state, $sce,$window, itemUpshelf) {
        ...
        $scope.querySeting = {
            items: [{
                ...
                model: 'putGoodsState',
                title: '业务状态',
                selectedModel: 'putGoodsStateSelect'
            }*/],
            btns: [{
        ...
        //table头
        $scope.thHeader = itemUpshelf.getThead();
        //分页下拉框
        $scope.pagingSelect = [{
            value: 5,
            text: 5
        ...
        var pmsSearch = itemUpshelf.getSearch();
...
//            $scope.searchModel.taskId = '';
        ...
        function get() {
            ...
            var promise = itemUpshelf.getDataTable({param: {query:opts}});
        ...
        $scope.print= function (i,item) {
            $window.open("../print/itemUpShel.html?tokenId="+$rootScope.userInfo.token+"&sessionid="+$rootScope.userInfo.sessionId+"&taskId="+item.taskId);
