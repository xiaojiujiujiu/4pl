 ...
 */
'use strict';
define(['../../../app', '../../../services/storage/order-qutbound/orderQutboundService'], function (app) {
     var app = angular.module('app');     app.controller('orderOutboundCtrl', ['$rootScope','$scope', '$state', '$sce', '$window', 'orderQutbound', function ($rootScope,$scope, $state, $sce, $window, orderQutbound) {
        // 头部标签跳转
...
//            }
        ...
        $scope.tabFlag = true;
        //table头
       // $scope.thHeader = orderQutbound.getThead();
        //分页下拉框
        $scope.pagingSelect = [{
            value: 5,
            text: 5
        ...
        function getQuery(packStatus){
            if(!packStatus){
                ...
                $scope.thHeader = orderQutbound.getThead2();
            }
            var sendParam = {
                param: {
                    query: {
            ...
            var pmsSearch = orderQutbound.getSearch(sendParam);
