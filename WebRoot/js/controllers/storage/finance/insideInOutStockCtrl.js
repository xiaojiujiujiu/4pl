 ...
 */
define(['../../../app','../../../services/storage/finance/insideInOutStockService'], function (app) {
     var app = angular.module('app');
    app.controller('insideInOutStockCtrl', ['$scope','$sce','insideInOutStock', function ($scope,$sce,insideInOutStock) {
        $scope.chinaCities = [
