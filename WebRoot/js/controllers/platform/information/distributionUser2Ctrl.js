 ...
 */
define(['../../../app','../../../services/platform/information/distributionUser2Service','../../../services/uploadFileService', '../../../services/addressLinkageService'], function (app) {
     var app = angular.module('app');
    app.controller('distributionUser2Ctrl', ['$rootScope', '$scope', '$state', '$sce', '$filter', 'HOST', '$window','distributionUser2','uploadFileService','addressLinkage',
        function ($rootScope, $scope, $state, $sce, $filter, HOST, $window, distributionUser2,uploadFileService,addressLinkage) {
            ...
            //table头
            $scope.thHeader = distributionUser2.getThead();
            ...
            $scope.enterAdd = function () {
                ...
                //台湾.香港.澳门
                //if(parseInt($scope.addModel.provinceSelected)!=420000&&parseInt($scope.addModel.provinceSelected)!=430000&&parseInt($scope.addModel.provinceSelected)!=440000) {
                //
                //}
                ...
                distributionUser2.getDataTable( $scope.giftTtle=='添加收件方'?'/distributionUser/addRecDistributionUser':'/distributionUser/updateRecDistributionUser', sendParams)
                    .then(function (data) {
            ...
            $scope.updateGift= function (i,item) {
                ...
                distributionUser2.getDataTable('/distributionUser/initRecDistributionUser', {param: {query: {id: item.id}}})
                    .then(function (data) {
            ...
            $scope.deleteCustom= function (i,item) {
                if(confirm('确定删除吗?')){
                    distributionUser2.getDataTable(
            ...
            var pmsSearch = distributionUser2.getSearch();
            ...
            function get() {
                ...
                var promise = distributionUser2.getDataTable(
                    '/distributionUser/getRecDistributionUserListByParty',
                    {
                        param: {
                            query: opts
                        }
            ...
            $scope.userNameAutocomplete= function (newValue) {
                ...
                return distributionUser2.autoCompletion({
                    param: {
                        query: opts
                    }
                });
